...
public interface ArticleTagMapper {
    ...
    void insetArticleTags(@Param(value = "articleTagList")List<ArticleTag> articleTagList);

    /**
     * 查询指定文章的所有标签
     * @param  articleId 文章id
     * @return List<ArticleTag></ArticleTag>
     */
    @Select("SELECT *FROM t_article_tag WHERE article_id=#{articleId}")
    List<ArticleTag> selectByArticledId(@Param("articleId")String articleId);
}
